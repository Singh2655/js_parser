...
export default class SourceMapper {
    ...
    constructor({ minifiedLocalPath }) {
        this.#minifiedLocalFilePath = minifiedLocalPath
        this.#sourceMaps = new SourceMapGenerator({ file: minifiedLocalPath })
    }
    ...
    #generateSourceMapData({ nameMap, originalCode }) {
        ...
        originalItems.map(({ newName, positions }) => {
            ...
            minifiedPositions.map((minifiedPosition, index) => {
